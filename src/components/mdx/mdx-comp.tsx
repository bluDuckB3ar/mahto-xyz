...
import { cn } from "@/components/mdx/lib/utils"
...
const components = {
  h1: ({ className, ...props } : React.HTMLAttributes<HTMLHeadingElement>) => (
    <h1
      className={cn(
        "mt-2 scroll-m-20 text-xl text-duckBlue  tracking-tight",
        className
      )}
      {...props}
    />
  ...
  h2: ({ className, ...props }  : React.HTMLAttributes<HTMLHeadingElement> ) => (
    <h2
      className={cn(
        "mt-10 scroll-m-20 border-b text-duckBlue pb-1 text-xl font-semibold tracking-tight first:mt-0",
        className
      )}
      {...props}
    />
  ...
  h3: ({ className, ...props }  : React.HTMLAttributes<HTMLHeadingElement> ) => (
    <h3
      className={cn(
        "mt-8 scroll-m-20 text-xl  text-duckBlue font-semibold tracking-tight",
        className
      )}
      {...props}
    />
